...
const functions = [
  {
    ...
    desc: "One prompt installs the right runtime connector",
    color: "#000000",
  },
  {
    id: "device-auth",
    label: "Device Auth",
    desc: "Short code browser authorization and auto-enroll",
    color: "#1a1a1a",
  },
  {
    id: "incident-correlation",
    label: "Incident Correlation",
    desc: "Group repeated events into a single response",
    color: "#2a2a2a",
  },
  {
    id: "package-shield",
    label: "Package Shield",
    desc: "Typosquat, lockfile, and lifecycle script checks",
    color: "#333333",
  },
  {
    id: "plugin-guard",
    label: "Plugin Guard",
    desc: "Integrity drift and command surface mapping",
    color: "#3a3a3a",
  },
  {
    id: "context-tree",
    label: "Policy Engine",
    desc: "Workspace, shell, and network enforcement rules",
    color: "#444444",
  },
  {
    id: "file-skeleton",
    label: "Intel Packs",
    desc: "Signed reputation packs for offline decisioning",
    color: "#4a4a4a",
  },
  {
    id: "semantic-search",
    label: "Prompt Defense",
    desc: "Detect approval farming and bypass attempts",
    color: "#555555",
  },
  {
    id: "identifier-search",
    label: "Audit Trail",
    desc: "Searchable runtime evidence and provenance",
    color: "#666666",
  },
  {
    id: "semantic-navigate",
    label: "Dashboard Sync",
    desc: "Stream incidents and health into the control plane",
    color: "#707070",
  },
  {
    id: "blast-radius",
    label: "Blast Radius",
    desc: "Estimate impacted agents, tools, and paths",
    color: "#7a7a7a",
  },
  {
    id: "static-analysis",
    label: "Self-Defense",
    desc: "Detect hook removal and config weakening",
    color: "#888888",
  },
  {
    id: "feature-hub",
    label: "Seat Enforcement",
    desc: "Free seat plus paid expansion tracking",
    color: "#999999",
  },
];

function getCardConfig(width: number, compact: boolean) {
  if (compact) {
    if (width >= 1400) return { cardSize: 204, stackDx: -14, stackDy: 14 };
    if (width >= 1100) return { cardSize: 185, stackDx: -13, stackDy: 13 };
    return { cardSize: 163, stackDx: -11, stackDy: 11 };
  }
...
export default function IsometricDiagram({ compact = false }: { compact?: boolean }) {
  ...
  const {
    ...
    stackDx: STACK_DX,
    stackDy: STACK_DY,
  } = getCardConfig(windowWidth, compact);
              ...
              : isVerySmallDesktop
                ...
                : isSmallDesktop
                  ...
                  : isLargeDesktop
                    ...
                    : -600,
        display: "flex",
        alignItems: compact ? "center" : isMobile ? "center" : "flex-end",
        aspectRatio: isMobile && !compact ? "1 / 1" : undefined,
        justifyContent: compact ? "center" : isMobile ? "center" : "flex-end",
        marginBottom: compact
          ? 0
          : `${isMobile ? 20 : isVerySmallDesktop ? 60 : isSmallDesktop ? 120 : 300}px !important`,
        padding: compact ? 0 : isMobile ? "0 20px 30px" : "0 100px 40px 100px",
        overflow: compact ? "visible" : isMobile ? "hidden" : undefined,
      }}
    >
      <div
        style={{
