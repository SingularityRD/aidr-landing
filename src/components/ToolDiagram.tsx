...
const toolGroupsLight = [
  {
    ...
    tools: [
      ...
      { color: "#333333", label: "Identifier Search" },
    ],
  },
  {
    name: "Response",
  ...
  },
  {
    ...
    layout: "column" as const,
    tools: [
      { color: "#888888", label: "Memory Search" },
      { color: "#999999", label: "Memory Upsert" },
    ],
  },
];
...
const toolGroupsDark = [
  {
    ...
    tools: [
      ...
      { color: "#cccccc", label: "Identifier Search" },
    ],
  },
  {
    name: "Response",
  ...
  },
  {
    ...
    layout: "column" as const,
    tools: [
      { color: "#777777", label: "Memory Search" },
      { color: "#666666", label: "Memory Upsert" },
    ],
  },
];
